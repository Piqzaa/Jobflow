<section class="legal-page">
        <h1 class="legal-page__title">Politique de confidentialité (RGPD)</h1>
        <p class="legal-date">Dernière mise à jour : <?= date('d/m/Y') ?></p>

        <h2 class="legal-page__section-title">1. Responsable du traitement</h2>
        ...
        <h2 class="legal-page__section-title">2. Données collectées</h2>
        <p class="legal-page__text">Dans le cadre de l'utilisation de Jobflow, les données suivantes sont collectées et traitées :</p>
        <ul>
        ...
        <p class="legal-page__text">Ces données sont saisies directement par l'utilisateur et stockées sur nos serveurs dans une base de données sécurisée.</p>
        <p class="legal-page__text">
        ...
        <h2 class="legal-page__section-title">3. Finalités du traitement</h2>
        <p class="legal-page__text">Les données collectées sont traitées aux fins suivantes :</p>
        <ul>
        ...
        <h2 class="legal-page__section-title">4. Base légale</h2>
        <p class="legal-page__text">Les traitements sont fondés sur les bases légales suivantes :</p>
        <ul>
        ...
        <h2 class="legal-page__section-title">5. Destinataires des données</h2>
        <p class="legal-page__text">Les données ne sont <strong>pas vendues ni transmises à des tiers à des fins commerciales</strong>. Elles peuvent être partagées avec :</p>
        <ul>
            <li>
        ...
        <h2 class="legal-page__section-title">6. Durée de conservation</h2>
        <ul>
        ...
        <h2 class="legal-page__section-title">7. Droits des utilisateurs</h2>
        <p class="legal-page__text">Conformément au RGPD (articles 15 à 22), vous disposez des droits suivants :</p>
        <ul>
        ...
        <h2 class="legal-page__section-title">8. Sécurité</h2>
        <p class="legal-page__text">
        ...
        <h2 class="legal-page__section-title">9. Cookies et stockage local</h2>
        <p class="legal-page__text">
        ...
        <h2 class="legal-page__section-title">10. Mineurs</h2>
        <p class="legal-page__text">
