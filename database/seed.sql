...
-- 4. Utilisateur de test n°2 (pour tester l'unicité par utilisateur)
INSERT INTO users (id, email, password, email_verified_at) VALUES 
(2, 'demo2@jobflow.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', NOW());

INSERT INTO user_profiles (user_id, nom, prenom, entreprise) VALUES 
(2, 'Martin', 'Sophie', 'Martin Consulting');

INSERT INTO clients (id, user_id, nom, email) VALUES 
(3, 2, 'Client de Sophie', 'sophie-client@test.com');
...
-- Devis pour User 2 (Même numéro, autorisé maintenant !)
INSERT INTO devis (id, user_id, client_id, numero, statut, date_emission, date_validite, montant_ht, montant_tva, montant_ttc) VALUES 
(2, 2, 3, 'DEV-2026-001', 'brouillon', '2026-05-30', '2026-06-30', 500.00, 0.00, 500.00);
...
(2, 'Conseil SEO', 5, 100.00, 0.00, 500.00, 500.00, 1);

-- 6. Une facture liée au devis de l'User 1
